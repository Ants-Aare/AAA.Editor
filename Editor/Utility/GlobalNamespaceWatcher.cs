...
using static AAA.Editor.Editor.Extensions.AssetDatabaseExtension;
...
namespace AAA.Editor.Editor.Utility
{
    public class GlobalNamespaceWatcher : EditorWindow
    {
        ...
        [SerializeField] bool m_ShowOnlyProjectAssemblies = true;

        [SerializeField] bool m_ShowOnlyMonoScriptTypes = true;

        [MenuItem("AAA/Find/Global Namespace Watcher", false, 4)]
